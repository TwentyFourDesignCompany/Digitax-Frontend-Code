...
const Partnerships = () => {
    ...
    useEffect(() => {
        axios.get(`https://weak-blue-bison-tutu.cyclic.cloud/api/v1/ioss/text/Partnerships`)
            .then((res) => {
                setIossTop(res?.data)
            })
            .catch((e) => {
        ...
        axios.get(`https://weak-blue-bison-tutu.cyclic.cloud/api/v1/ioss/question/Partnerships`)
            .then((res) => {
        ...
        axios.get(`https://weak-blue-bison-tutu.cyclic.cloud/api/v1/ioss/image/Partnerships`)
            .then((res) => {
        ...
        // HOW IT WORKS
        axios.get(`https://weak-blue-bison-tutu.cyclic.cloud/api/v1/work/role/Partnerships`)
            .then((res) => {
                setworks(res?.data)
            })
            .catch((e) => {
