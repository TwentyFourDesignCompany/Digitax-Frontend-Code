...
const Ioss = () => {
  ...
  useEffect(() => {
    // HEAD PART 
    axios.get(`https://weak-blue-bison-tutu.cyclic.cloud/api/v1/ioss/text/IOSS`)
      .then((res) => {
        setIossTop(res?.data)
      })
    ...
    axios.get(`https://weak-blue-bison-tutu.cyclic.cloud/api/v1/ioss/question/IOSS`)
      .then((res) => {
    ...
    // QUESTION WITH IMAGE 
    axios.get(`https://weak-blue-bison-tutu.cyclic.cloud/api/v1/ioss/image/IOSS`)
      .then((res) => {
    ...
    // HOW IT WORKS
    axios.get(`https://weak-blue-bison-tutu.cyclic.cloud/api/v1/work/role/IOSS`)
      .then((res) => {
        console.log(res)
        setworks(res?.data)
      })
