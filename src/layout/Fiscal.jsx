...
const Fiscal = () => {
  ...
  useEffect(() => {
    axios.get(`https://weak-blue-bison-tutu.cyclic.cloud/api/v1/ioss/text/Fiscal Representation`)
      .then((res) => {
        setIossTop(res?.data)
      })
      .catch((e) => {
    ...
    axios.get(`https://weak-blue-bison-tutu.cyclic.cloud/api/v1/ioss/question/Fiscal Representation`)
      .then((res) => {
    ...
    axios.get(`https://weak-blue-bison-tutu.cyclic.cloud/api/v1/ioss/image/Fiscal Representation`)
      .then((res) => {
    ...
    // HOW IT WORKS
    axios.get(`https://weak-blue-bison-tutu.cyclic.cloud/api/v1/work/role/Fiscal Representation`)
      .then((res) => {
        console.log(res)
        setworks(res?.data)
      })
  ...
  const delTopIoss = (id) => {
    axios.delete(`https://weak-blue-bison-tutu.cyclic.cloud/api/v1/ioss/text/${id}`)
      .then((res) => {
        if (res.status === 200) {
  ...
  const delQuestion = (id) => {
    axios.delete(`https://weak-blue-bison-tutu.cyclic.cloud/api/v1/ioss/question/${id}`)
      .then((res) => {
        if (res.status === 200) {
          toast("Deleted Successfully");
  ...
  const delImageQuestion = (id) => {
    axios.delete(`https://weak-blue-bison-tutu.cyclic.cloud/api/v1/ioss/image/${id}`)
      .then((res) => {
        if (res.status === 200) {
          toast("Deleted Successfully");
  ...
  const deleteData = (id) => {
    axios.delete(`https://weak-blue-bison-tutu.cyclic.cloud/api/v1/work/${id}`)
      .then((res) => {
        if (res.status === 200) {
          toast("Deleted Successfully");
